...
import { getEntity, deleteEntity } from './quotation.reducer';
...
export const QuotationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="crmgpApp.quotation.delete.question">
        <Translate contentKey="crmgpApp.quotation.delete.question" interpolate={{ id: quotationEntity.id }}>
