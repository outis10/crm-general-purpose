  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmgpApp.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="crmgpApp.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('crmgpApp.notification.type')}
              ...
              >
                {notificationTypeValues.map(notificationType => (
                  <option value={notificationType} key={notificationType}>
                    {translate('crmgpApp.NotificationType.' + notificationType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('crmgpApp.notification.message')}
              ...
              />
              <ValidatedField
                label={translate('crmgpApp.notification.read')}
              ...
              />
              <ValidatedField
                label={translate('crmgpApp.notification.createdAt')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('crmgpApp.notification.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
