  ...
  return (
    <div>
      <h2 id="contact-heading" data-cy="ContactHeading">
        <Translate contentKey="crmgpApp.contact.home.title">Contacts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="crmgpApp.contact.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/contact/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="crmgpApp.contact.home.createLabel">Create new Contact</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contactList && contactList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="crmgpApp.contact.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="crmgpApp.contact.city">City</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('city')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crmgpApp.contact.home.notFound">No Contacts found</Translate>
            </div>
          )
        )}
      </div>
