...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('however nougat velvety');
      cy.get(`[data-cy="name"]`).should('have.value', 'however nougat velvety');

      cy.get(`[data-cy="description"]`).type('given asXX');
      cy.get(`[data-cy="description"]`).should('have.value', 'given asXX');

      cy.get(`[data-cy="price"]`).type('18157.65');
      cy.get(`[data-cy="price"]`).should('have.value', '18157.65');

      cy.get(`[data-cy="stock"]`).type('12664');
      cy.get(`[data-cy="stock"]`).should('have.value', '12664');

      cy.get(`[data-cy="sku"]`).type('aboard disinvest');
      cy.get(`[data-cy="sku"]`).should('have.value', 'aboard disinvest');
