...
import com.outis.crmgp.repository.ContactRepository;
import com.outis.crmgp.service.ContactService;
import com.outis.crmgp.service.dto.ContactDTO;
import com.outis.crmgp.service.mapper.ContactMapper;
...
class ContactResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "n{M<9@iGmJE.,<0!";
    private static final String UPDATED_EMAIL = "JGSFdq@]%XcO'.J!iN";

    private static final String DEFAULT_PHONE = "5135";
    private static final String UPDATED_PHONE = "+2047808";
    ...
    private static final String DEFAULT_POSTAL_CODE = "39986-9062";
    private static final String UPDATED_POSTAL_CODE = "62618-5901";
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.middleName(UPDATED_MIDDLE_NAME).address(UPDATED_ADDRESS).socialMediaProfiles(UPDATED_SOCIAL_MEDIA_PROFILES);
