...
import com.outis.crmgp.repository.OrderRepository;
import com.outis.crmgp.service.dto.OrderDTO;
import com.outis.crmgp.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    private static final Instant DEFAULT_SHIPPING_AT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SHIPPING_AT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order()
            ...
            .shippingAt(DEFAULT_SHIPPING_AT)
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order()
            ...
            .shippingAt(UPDATED_SHIPPING_AT)
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].shippingAt").value(hasItem(DEFAULT_SHIPPING_AT.toString())))
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.shippingAt").value(DEFAULT_SHIPPING_AT.toString()))
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.createdAt(UPDATED_CREATED_AT).quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE).status(UPDATED_STATUS);
