...
import static com.outis.crmgp.domain.NotificationAsserts.*;
...
import com.outis.crmgp.repository.NotificationRepository;
import com.outis.crmgp.repository.UserRepository;
import com.outis.crmgp.service.dto.NotificationDTO;
import com.outis.crmgp.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.type(UPDATED_TYPE).message(UPDATED_MESSAGE).read(UPDATED_READ).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.type(UPDATED_TYPE).message(UPDATED_MESSAGE).read(UPDATED_READ).createdAt(UPDATED_CREATED_AT);
